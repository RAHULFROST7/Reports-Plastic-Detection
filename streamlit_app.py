...
filepath = r"E:\Projects and codes\Visualization for reva\synthetic_data.csv"
...
# Load GeoJSON data
with open(r'E:\Projects and codes\Visualization for reva\india_state_geo.json') as file:
